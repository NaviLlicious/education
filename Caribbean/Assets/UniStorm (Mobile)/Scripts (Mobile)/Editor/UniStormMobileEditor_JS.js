//UniStorm Mobile Weather System Editor JavaScript Version 2.1.0 @ Copyright
    ...
    function OnInspectorGUI () 
    {
		...
		if (confirmationToGenerate)
		{
			...
			if(GUILayout.Button("Random"))
			{
				...
				{
					target.realStartTime = Random.Range(0, 24);
					target.realStartTimeMinutes = Random.Range(0, 60);
			...
			{
				target.realStartTime = 11;
				target.realStartTimeMinutes = 0;
