//UniStorm Mobile Weather System Editor C# Version 1.8.5 @ Copyright
	...
	public override void OnInspectorGUI () 
	{
		...
		if (confirmationToGenerate)
		{
			...
			if(GUILayout.Button("Random"))
			{
				...
				{
					self.realStartTime = Random.Range(0, 24);
					self.realStartTimeMinutes = Random.Range(0, 60);
			...
			{
				self.realStartTime = 11;
				self.realStartTimeMinutes = 0;
				self.dayCounter = 15;
				self.monthCounter = 6;
