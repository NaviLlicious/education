...
SubShader {
	...
	ZTest LEqual	
	CGPROGRAM
	#pragma surface surf Standard vertex:vert finalcolor:customFog exclude_path:prepass noforwardadd
	// U5 fog handling
...
ZTest LEqual	
CGPROGRAM
	#pragma surface surf Standard vertex:vert finalcolor:customFog exclude_path:prepass decal:blend noforwardadd
	// U5 fog handling
	#pragma multi_compile_fog		
	#pragma target 3.0
	#pragma glsl
